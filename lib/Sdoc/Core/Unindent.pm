...
Sdoc::Core::Unindent - Entferne Einrückung von "Here Document" oder String-Literal
...
Fortsetzungszeichen. Siehe Sdoc::Core::String->joinLines().
...
sub hereDoc {
    ...
    if (defined $char) {
        $str = Sdoc::Core::String->joinLines($char,$str);
    }
