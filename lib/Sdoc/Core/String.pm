...
Sdoc::Core::String - Operationen auf Zeichenketten
...
sub determineIndentation {
    ...
    return Sdoc::Core::Array->gcd([keys %ind]);
}
...
Reduktion auf Einrücktiefe 2:
  ...
  Sdoc::Core::String->reduceIndentation(2,$str);
...
HTML, XML:
  ...
  $code = Sdoc::Core::String->removeComments($code,'<!--','-->');
...
Verwende die Tilde (~) als Fortsetzungszeichen:
  ...
  Sdoc::Core::String->joinLines('~',"Dies ist ~\nein Text");
  ==>
  "Dies ist ein Text"
...
Maximale Zeilenlänge auf 12 Zeichen begrenzen:
  ...
  $txt = Sdoc::Core::String->wrap($txt,-width=>12);
  # =>
  Dies ist ein
  Test mit
  einem kurzen
