...
Sdoc::Core::Stacktrace - Generiere und visualisiere einen Stacktrace

=head1 SYNOPSIS

  use Sdoc::Core::Stacktrace;
  
  my $st = Sdoc::Core::Stacktrace->new; # generiere Stacktrace
...
erzeugt die Ausgabe
  ...
  main::a() [+17 ./test.pl]
    main::b() [+6 ./test.pl]
      main::c() [+10 ./test.pl]
        Sdoc::Core::Stacktrace::asString() [+14 ./test.pl]
