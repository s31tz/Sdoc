...
Sdoc::Core::CommandLine - Konstruiere eine Unix-Kommandozeile
...
=head1 SYNOPSIS
  ...
  my $c = Sdoc::Core::CommandLine->new('iconv');
  $c->addOption(
      -f => 'utf-8',
      -t => 'latin1',
  );
...
Erzeuge eine Kommandozeile für das Kommando C<enscript>:
  ...
  $c = Sdoc::Core::CommandLine->new('enscript');
