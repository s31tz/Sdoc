package Sdoc::Core::LaTeX::Code;
use base qw/Sdoc::Core::TeX::Code/;
...
Sdoc::Core::LaTeX::Code - Generator für LaTeX Code

=head1 BASE CLASS

L<Sdoc::Core::TeX::Code>
...
sich ab auf ihre Basisklasse Sdoc::Core::TeX::Code. Weitere Methoden
siehe dort.
