...
Sdoc::Core::LineProcessor - Verarbeite Datei als Array von Zeilen
...
der Klasse Sdoc::Core::LineProcessor::Line). Die Klasse stellt
...
=item -lineClass => $class (Default: 'Sdoc::Core::LineProcessor::Line')
...
sub new {
    ...
    my $encoding;
    my $lineClass = 'Sdoc::Core::LineProcessor::Line';
