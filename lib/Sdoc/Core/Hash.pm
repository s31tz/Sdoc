...
Sdoc::Core::Hash - Zugriffssicherer Hash mit automatisch generierten Attributmethoden
...
Hash-Objekt instantiieren:
  ...
  my $h = Sdoc::Core::Hash->new(a=>1,b=>1,c=>3);
...
entsperrt werden:
  ...
  return Sdoc::Core::Hash->new(...)->unlockKeys;
