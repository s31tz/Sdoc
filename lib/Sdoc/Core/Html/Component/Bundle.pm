...
Sdoc::Core::Html::Component::Bundle - Bündel von HTML-Komponenten
...
=head1 SYNOPSIS
  ...
  # Instantiiere Objekt
  $b = Sdoc::Core::Html::Component::Bundle->new(\@components);
...
vom Typ Sdoc::Core::Html::Component und stellt Methoden zur Verfügung,
