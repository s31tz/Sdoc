...
Sdoc::Core::Html::Table::List - HTML-Tabelle zum Anzeigen einer Liste von Elementen

=head1 BASE CLASS

L<Sdoc::Core::Html::Table::Base>
...
package Sdoc::Core::Html::Table::List;
use base qw/Sdoc::Core::Html::Table::Base/;
