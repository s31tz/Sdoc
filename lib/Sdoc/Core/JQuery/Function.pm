package Sdoc::Core::JQuery::Function;
...
Sdoc::Core::JQuery::Function - Nützliche Funktionen für jQuery
...
sub formatDate {
    ...
    return Sdoc::Core::Unindent->hereDoc(<<'    __JS__');
    (function($) {
        var patternParts =
...
sub ready {
    my $this = shift;
    my $body = Sdoc::Core::Unindent->trim(shift);
    $body =~ s/^/    /mg;
    return "\$(function() {\n$body\n});"
}
